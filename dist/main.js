...
var map = {
	...
	"./dashboard/dashboard.module": [
		...
		"dashboard-dashboard-module~home-home-module~views-views-module",
		"common",
		"dashboard-dashboard-module"
	],
	"./home/home.module": [
...
var routes = [
    { path: '', loadChildren: './views/views.module#ViewsModule', canActivate: [_shared__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
...
var IS_LOCAL = true;
var api = 'http://dokio.ndu-systems.net/api';
var web = 'http://dokio.ndu-systems.net';
if (IS_LOCAL) {
...
var SelectService = /** @class */ (function () {
    ...
    SelectService.prototype.getCounts = function () {
        return this.http.get(this.url + "/get-counts.php");
    };
